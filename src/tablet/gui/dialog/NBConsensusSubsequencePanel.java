...
public class NBConsensusSubsequencePanel extends javax.swing.JPanel
{
    public NBConsensusSubsequencePanel(ConsensusSubsequenceDialog parent, int start, int end)
	{
        initComponents();
